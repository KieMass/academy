...
export function generateAllMathsQuestionsY6(seed = 6250): DraftQuestion[] {
  ...
  return [
    ...generateNumberComparisonY6Questions(rng, 20),
    ...generateRoundingY6Questions(rng, 20),
    ...generateNegativeIntervalY6Questions(rng, 16),
    ...generateMixedMentalY6Questions(rng, 16),
    ...generateEstimationY6Questions(rng, 16),
    ...generateLongMultiplicationY6Questions(rng, 24),
    ...generateFactorsMultiplesY6Questions(rng, 16),
    ...generateOrderOfOperationsY6Questions(rng, 16),
    ...generateLongDivisionY6Questions(rng, 24),
    ...generateDivisionRemainderY6Questions(rng, 12),
    ...generateFractionCompareY6Questions(rng, 20),
    ...generateFractionAddSubDifferentDenomY6Questions(rng, 24),
    ...generateFractionMultiplyY6Questions(rng, 16),
    ...generateFractionDivideY6Questions(rng, 12),
    ...generateFractionDecimalEquivY6Questions(rng, 12),
    ...generateDecimalPlaceValueY6Questions(rng, 16),
    ...generateDecimalScaleY6Questions(rng, 20),
    ...generateDecimalMultiplyY6Questions(rng, 16),
    ...generateDecimalDivisionY6Questions(rng, 12),
    ...generatePercentageChangeY6Questions(rng, 16),
    ...generateFDPEquivalenceY6Questions(rng, 16),
    ...generateLinearSequenceY6Questions(rng, 12),
    ...generateSimpleFormulaY6Questions(rng, 12),
    ...generateRatioShareY6Questions(rng, 16),
    ...generateMeanY6Questions(rng, 12),
  ];
}
...
export function generateAllMathsQuestionsY6Extra(seed = 62500): DraftQuestion[] {
  const rng = createRng(seed);
  return [
    ...generateNumberComparisonY6Questions(rng, 24),
    ...generateRoundingY6Questions(rng, 24),
    ...generateNegativeIntervalY6Questions(rng, 20),
    ...generateMixedMentalY6Questions(rng, 20),
    ...generateEstimationY6Questions(rng, 20),
    ...generateLongMultiplicationY6Questions(rng, 28),
    ...generateFactorsMultiplesY6Questions(rng, 20),
    ...generateOrderOfOperationsY6Questions(rng, 20),
    ...generateLongDivisionY6Questions(rng, 28),
    ...generateDivisionRemainderY6Questions(rng, 16),
    ...generateFractionCompareY6Questions(rng, 24),
    ...generateFractionAddSubDifferentDenomY6Questions(rng, 28),
    ...generateFractionMultiplyY6Questions(rng, 20),
    ...generateFractionDivideY6Questions(rng, 16),
    ...generateFractionDecimalEquivY6Questions(rng, 16),
    ...generateDecimalPlaceValueY6Questions(rng, 20),
    ...generateDecimalScaleY6Questions(rng, 24),
    ...generateDecimalMultiplyY6Questions(rng, 20),
    ...generateDecimalDivisionY6Questions(rng, 16),
    ...generatePercentageChangeY6Questions(rng, 20),
    ...generateFDPEquivalenceY6Questions(rng, 20),
    ...generateLinearSequenceY6Questions(rng, 16),
    ...generateSimpleFormulaY6Questions(rng, 16),
    ...generateRatioShareY6Questions(rng, 20),
    ...generateMeanY6Questions(rng, 16),
  ];
}
...
export function generateAllMathsQuestions(seed = 5150): DraftQuestion[] {
  const rng = createRng(seed);
  return [
    ...generateAdditionQuestions(rng, 28),
    ...generateSubtractionQuestions(rng, 28),
    ...generateMultiplicationQuestions(rng, 32),
    ...generateDivisionQuestions(rng, 28),
    ...generatePlaceValueQuestions(rng, 28),
    ...generateDecimalQuestions(rng, 28),
    ...generateFractionQuestions(rng, 32),
    ...generatePercentageQuestions(rng, 24),
    ...generateNumberComparisonQuestions(rng, 16),
    ...generateNegativeNumberQuestions(rng, 16),
    ...generateRomanNumeralQuestions(rng, 12),
    ...generateMentalAdditionQuestions(rng, 16),
    ...generateRoundingEstimateQuestions(rng, 12),
    ...generateMentalSubtractionQuestions(rng, 16),
    ...generatePrimeQuestions(rng, 16),
    ...generateSquareCubeQuestions(rng, 16),
    ...generateMixedNumberQuestions(rng, 16),
    ...generateFractionAddSubQuestions(rng, 20),
    ...generateDecimalCompareQuestions(rng, 16),
    ...generateDecimalFractionQuestions(rng, 16),
    ...generatePercentFractionDecimalQuestions(rng, 16),
  ];
}
...
export function generateAllMathsQuestionsExtra(seed = 51500): DraftQuestion[] {
  const rng = createRng(seed);
  return [
    ...generateAdditionQuestions(rng, 32),
    ...generateSubtractionQuestions(rng, 32),
    ...generateMultiplicationQuestions(rng, 36),
    ...generateDivisionQuestions(rng, 32),
    ...generatePlaceValueQuestions(rng, 32),
    ...generateDecimalQuestions(rng, 32),
    ...generateFractionQuestions(rng, 36),
    ...generatePercentageQuestions(rng, 28),
    ...generateNumberComparisonQuestions(rng, 20),
    ...generateNegativeNumberQuestions(rng, 20),
    ...generateRomanNumeralQuestions(rng, 16),
    ...generateMentalAdditionQuestions(rng, 20),
    ...generateRoundingEstimateQuestions(rng, 16),
    ...generateMentalSubtractionQuestions(rng, 20),
    ...generatePrimeQuestions(rng, 20),
    ...generateSquareCubeQuestions(rng, 20),
    ...generateMixedNumberQuestions(rng, 20),
    ...generateFractionAddSubQuestions(rng, 24),
    ...generateDecimalCompareQuestions(rng, 20),
    ...generateDecimalFractionQuestions(rng, 20),
    ...generatePercentFractionDecimalQuestions(rng, 20),
  ];
}
...
export function generateAllMathsQuestionsExtra2(seed = 81500): DraftQuestion[] {
  const rng = createRng(seed);
  return [
    ...generateAdditionQuestions(rng, 24),
    ...generateSubtractionQuestions(rng, 24),
    ...generateMultiplicationQuestions(rng, 28),
    ...generateDivisionQuestions(rng, 24),
    ...generatePlaceValueQuestions(rng, 24),
    ...generateDecimalQuestions(rng, 24),
    ...generateFractionQuestions(rng, 28),
    ...generatePercentageQuestions(rng, 20),
    ...generateNumberComparisonQuestions(rng, 16),
    ...generateNegativeNumberQuestions(rng, 16),
    ...generateMentalAdditionQuestions(rng, 16),
    ...generateMentalSubtractionQuestions(rng, 16),
